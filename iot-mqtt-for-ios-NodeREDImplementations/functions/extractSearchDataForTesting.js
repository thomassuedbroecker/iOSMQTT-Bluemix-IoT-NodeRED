...
if (msg.payload[0] !== null) { // Check Array is empty

    if (msg.payload[0].sensordatavalue !== undefined) // Check Data Format exist
    {
        // Check valid payload
            ...
            (msg.payload[0].sensordatavalue.message!==undefined))
        {
          ...
          // You can see the output in the Bluemix Application Console Output
