...
//****************************
// Bluemix Mobile Integration
// for more detail in case of problems see
// https://developer.ibm.com/answers/questions/182317/imfcoreimfcoreh-file-not-found.html
// Implementation Sample: https://github.com/ibm-bluemix-mobile-services/bms-samples-ios-bluelist/blob/master/bluelist-objective-c/bluelist-objective-c/AppDelegate.m
// Video: https://www.youtube.com/watch?v=rzFQInkcOPw
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // ****************************************
    // MobileClientAccess-Integration - Bluemix
    // ****************************************   
    IMFLogger *logger;
    [[IMFClient sharedInstance]
     initializeWithBackendRoute:@"https://MobileFirstServices-tsuedbro.eu-gb.mybluemix.net"
     //initializeWithBackendRoute:@"https://MobileFirstServicesTsuedbro.mybluemix.net"
     backendGUID:@"be37c319-a9a2-4593-81d8-4f0a861031e6"];
     //backendGUID:@"ca9b56d5-20cf-4faa-83cb-5a012d8ce4fb"];
